...
void initialize_radar_system(int radar[]) {
    ...
    ///////////////////
    // Your Code Here //
    for(int i = 0;i < MAX_RADAR_CAPACITY;i++)radar[i] = 0;
    ///////////////////
}
...
int engage_in_battle(int radar[], int alienID) {
    ...
    for(int i = 0;i < MAX_RADAR_CAPACITY;i++)
    {
        if(radar[i] == alienID){radar[i] = 0;eliminated++;}
    }
    return eliminated;
    ///////////////////
...
int count_total_alien_ships(int radar[]) {
    ///////////////////
    // Your Code Here //
    int counting_alien = 0;
     for(int i = 0;i < MAX_RADAR_CAPACITY;i++)
    {
        counting_alien = (radar[i] == 0)? counting_alien : counting_alien + 1;
    }
    return counting_alien;
    ///////////////////
}
...
void display_radar_status(int radar[]) {
    ///////////////////
    // Your Code Here //
    cout << "Radar Status: [" << radar[0] << " " << radar[1] << " " << radar[2] << " " << radar[3] << " " << radar[4] << "]" <<endl;
    ///////////////////
}
